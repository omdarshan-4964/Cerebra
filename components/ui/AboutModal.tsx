  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-2xl bg-white rounded-2xl p-6 shadow-xl border">
        <h3 className="text-xl font-bold mb-2 text-gray-900">About Cerebra</h3>
        ...
        <h4 className="font-semibold mt-4 text-gray-900">Purpose & Features</h4>
